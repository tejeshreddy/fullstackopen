...
sequenceDiagram
    ...
    deactivate server
    Note right of browser: The browser begins redirect to /exampleapp/notes with the new note
...
sequenceDiagram
    ...
    activate server
    server-->>browser: the css file (Status: 200 OK)
    deactivate server

    browser->>server: GET https://studies.cs.helsinki.fi/exampleapp/spa.js

    activate server
    server-->>browser: the JavaScript file (Status: 200 OK)
    deactivate server
    ...
    browser->>server: GET https://studies.cs.helsinki.fi/exampleapp/data.json
    activate server
    server-->>browser: "[{ "content": "HTML is crazy easy", "date": "2023-1-1" }, ... ] ( Status 200 OK)
    deactivate server
